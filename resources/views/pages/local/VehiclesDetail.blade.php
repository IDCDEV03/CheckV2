...
<div class="col-md-6 mb-4">
        <div class="mt-25 card card-default card-md shadow-sm text-center">
            <div class="card-body">
                ...
                <!-- รูปภาพรถ -->
                <div class="mb-4 mt-4">
                    <img src="{{ asset($vehicle->veh_image) }}"
                         alt="ภาพรถ"
                    ...
                    <table class="table table-bordered table-hover mb-0 text-start">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>15 มีนาคม 2566</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>หนังสือแจ้งซ่อม #002</td>
                                <td>28 เมษายน 2566</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>หนังสือแจ้งซ่อม #003</td>
                                <td>5 พฤษภาคม 2566</td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>หนังสือแจ้งซ่อม #004</td>
                                <td>12 พฤษภาคม 2566</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card mt-2 mb-25 shadow-sm">
                                <div class="card-header">
                                    <span class="fs-20 mb-0">ผลการตรวจรถ</span>
                                </div>
                                <div class="card-body">
